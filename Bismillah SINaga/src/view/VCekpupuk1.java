...
public class VCekpupuk1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        JTiang.setText("10000 M persegi");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VCekpupuk1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VCekpupuk1().setVisible(true);
            }
        });
    }
